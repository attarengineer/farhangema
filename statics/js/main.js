   ...
   "use strict";
    ...
    $(document).ready(function () {
        ...
        if ($(window).width() < 992) {
            ...
            $(".in-mobile ul li.menu-item-has-children").append('<i class="fas fa-chevron-left"></i>');
            $('<i class="fas fa-chevron-left"></i>').insertAfter("");
        ...
        /* -----------------------------------------------------
            Variables
        ----------------------------------------------------- */
        var leftArrow = '<i class="fa fa-arrow-right"></i>';
        var leftAngle = '<i class="fa fa-angle-right"></i>';
        var rightArrow = '<i class="fa fa-arrow-left"></i>';
        var rightAngle = '<i class="fa fa-angle-left"></i>';
